...
<div class="sidebar">
    <h2 style="text-align: center; margin-bottom: 20px;">Comedor Universitario</h2>
    <ul class="sidebar-menu">
        ...
        <?php else: ?>
            ...
            <li><a href="#" class="nav-btn" data-page="Admin/graficos.php"><i class="fas fa-chart-bar"></i> Reportes</a></li>
        <?php endif; ?>
        <li><a href="../Models/authlogin/logout.php"><i class="fas fa-sign-out-alt"></i> Cerrar Sesión</a></li>
    </ul>
</div>
